<template>
  <div class="collectCard">
    ...
    <div class="luckyDraw" v-if="successCard && gameState">
      已集满,10月18号开奖
    </div>
    <div class="luckyDraw" v-if="successCard && !gameState" @click="choujiang">
      立即开奖
    </div>
    <div class="noLuckyDraw" v-if="!successCard && gameState">
      未集齐卡片无法抽奖
    </div>
    ...
    <div class="successCardRemin" v-if="DrawPrizeVis">
      <img src="../assets/huafei.jpg" />
      <div class="furl-card" @click="
          DrawPrizeVis = false;
          DrawPrizeBtn = false;
        " v-if="DrawPrizeBtn" style="top:6rem">
        恭喜中奖!
      </div>
    </div>
  </div>
  ...
  .collectCard {
    ...
    .successCardRemin {
      ...
      .enlargeImg {
        width: 4.6rem;
        transform: scale(1);
        animation: scaleImg 0.4s ease 1;
