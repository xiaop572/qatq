<template>
  <div class="home">
    ...
    <div class="topic-box" v-for="(item,index) in topicList" :key="index">
      ...
      <template v-else>
        <van-checkbox-group v-model="answers[index].value" icon-size="0.3rem" checked-color="#3366cc">
          <van-checkbox v-for="(ans,index) in item.answer" :key="index" :name="ans.name" shape="square">{{ans.name}}
          </van-checkbox>
        </van-checkbox-group>
        <p class="extra">
