...
let AppID = "wx4d5acc5b135d2221"
let AppSecret = "d58c2aedae3e6aad8d987d0a73119ae8"
...
router.get('/login', async (req, res) => {
    ...
    var return_uri = 'http%3A%2F%2Fpa.lin526.cn%2F' + routerPath;
                    ...
                    async function (error, response, body) {
                        if (response.statusCode == 200) {
                            ...
                            if (req.cookies.superior) {
                                res.redirect(301, 'http://pa.lin526.cn/?openid=' + userinfo.openid + '&superior=' + req.cookies.superior);
                            } else {
                                res.redirect(301, 'http://pa.lin526.cn/?openid=' + userinfo.openid);
                            }
